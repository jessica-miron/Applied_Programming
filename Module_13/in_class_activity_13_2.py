##########################################################
## OncoMerge:  in_class_activity_13_2.py                ##
##  ______     ______     __  __                        ##
## /\  __ \   /\  ___\   /\ \/\ \                       ##
## \ \  __ \  \ \___  \  \ \ \_\ \                      ##
##  \ \_\ \_\  \/\_____\  \ \_____\                     ##
...
def slugify(s):
    s = s.lower().strip()
    s = re.sub(r'[^\w\s-]', '', s)  # Remove non-alphanumeric (except space and hyphen)
    s = re.sub(r'[\s_-]+', '-', s)  # Replace spaces/underscores with single hyphens
...
class miRvestigator:
    ...
    def __init__(self,pssms,seedModel=[6,7,8], minor=True, p5=True, p3=True, textOut=True, wobble=True, wobbleCut=0.25,species='hsa'):
        ...
        for pssm in pssms:
            ...
            print('Done.\n')
            # Calculate the background distribution of p-values for the PSSM
            if 6 in seedModel:
